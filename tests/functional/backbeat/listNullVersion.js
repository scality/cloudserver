    ...
    before(done => {
        ...
        return async.series(
            [
                ...
                next =>
                    s3.putObject({ Bucket: testBucket, Key: 'key1', Body: '123' }, (err, data) => {
                        if (err) {
                            return next(err);
                        }
                ...
                next =>
                    s3.putObject({ Bucket: testBucket, Key: 'key2', Body: '123' }, (err, data) => {
                        if (err) {
                            return next(err);
                        }
    ...
    before(done => {
        ...
        return async.series(
            [
                ...
                next =>
                    s3.putObject({ Bucket: nullObjectBucket, Key: keyName }, (err, data) => {
                        if (err) {
                            return next(err);
                        }
