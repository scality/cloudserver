...
async function mpuUploadPart({ UploadId, Bucket, Key, Body, PartNumber }, mpuOverviewMDSSE, algo, testCase) {
    // eslint-disable-next-line no-console
    console.log('MPUUPLOADDDD', { UploadId, Bucket, Key, Body, PartNumber });
...
async function mpuComplete({ UploadId, Bucket, Key }, { existingParts, newParts }, mpuOverviewMDSSE, algo, testCase) {
    // eslint-disable-next-line no-console
    console.log('=== MPU COMPLETE DEBUG ===');
    // eslint-disable-next-line no-console
    console.log('existingParts:', JSON.stringify(existingParts, null, 2));
    // eslint-disable-next-line no-console
    console.log('newParts:', JSON.stringify(newParts, null, 2));
    ...
    // eslint-disable-next-line no-console
    console.log('Final parts for completion:', JSON.stringify(allParts, null, 2));
