...
describe('get behavior on versioning-enabled bucket', () => {
    withV4(sigCfg => {
        ...
        describe('behavior when only version put is a delete marker', () => {
            ...
            it('it should return NoSuchKey if try to get object whose ' + 'latest version is a delete marker', done => {
                s3.getObject(
                    {
                        Bucket: bucket,
                        Key: key,
        ...
        describe('behavior when put version with content then put delete ' + 'marker', () => {
            ...
            it('should be able to get a version that was put prior to the ' + 'delete marker', function itF(done) {
                s3.getObject(
                    {
                        Bucket: bucket,
                        Key: key,
            ...
            it(
                'should return NoSuchKey if get object without version and ' + 'latest version is a delete marker',
                done => {
                    s3.getObject(
                        {
                            Bucket: bucket,
        ...
        describe('x-amz-tagging-count with versioning', () => {
            ...
            it('should not return "x-amz-tagging-count" if no tag ' + 'associated with the object', function itF(done) {
