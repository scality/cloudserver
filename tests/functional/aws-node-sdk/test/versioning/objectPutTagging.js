...
describe('Put object tagging with versioning', () => {
    withV4(sigCfg => {
        ...
        it(
            'should not create version putting object tags on a ' +
        ...
        it(
            'should return 405 MethodNotAllowed putting tag without ' +
        ...
        it(
            'should return 405 MethodNotAllowed putting tag with ' +
                'version id if version specified is a delete marker',
            done => {
                async.waterfall(
                    [
