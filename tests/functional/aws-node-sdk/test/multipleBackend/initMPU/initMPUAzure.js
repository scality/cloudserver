...
const { describeSkipIfNotMultipleOrCeph, azureLocation, getAzureContainerName, genUniqID } = require('../utils');
            ...
            it('should create MPU and list in-progress multipart uploads', function ifF(done) {
                ...
                async.waterfall(
                    [
                        ...
                        next =>
                            s3.listMultipartUploads({ Bucket: azureContainerName }, (err, res) => {
