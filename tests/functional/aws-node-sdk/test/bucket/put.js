    ...
    withV4(sigCfg => {
        ...
        describe('create bucket twice', () => {
            ...
            it('should return a 200 if us-east behavior', async () => {
                const res = await bucketUtil.s3.send(
                    new CreateBucketCommand({
                        Bucket: testBucketName,
                        CreateBucketConfiguration: {
                            LocationConstraint: 'us-east-1',
                ...
                testFn = (bucketName, done, errStatus, errCode) => {
                    ...
                    bucketUtil
                        ...
                        .catch(error => {
                            ...
                            assert.strictEqual(error.$metadata.httpStatusCode, expectedStatus);
                            done();
                        });
                };
            });
                    ...
                    bucketUtil.s3
                        ...
                        .catch(err => {
                            if (location === LOCATION_NAME_DMF) {
                                assert.strictEqual(err.name, 'InvalidLocationConstraint');
