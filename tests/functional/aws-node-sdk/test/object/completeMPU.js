...
describe('Complete MPU', () => {
    withV4(sigCfg => {
        ...
        describe('on bucket with enabled versioning', () => {
            ...
            beforeEach(() =>
                s3
                    .putBucketVersioning({ Bucket: bucket, VersioningConfiguration: versioningEnabled })
                    .promise()
        ...
        describe('on bucket with suspended versioning', () => {
            ...
            beforeEach(() =>
                s3
                    .putBucketVersioning({ Bucket: bucket, VersioningConfiguration: versioningSuspended })
                    .promise()
                    .then(() => _initiateMpuAndPutOnePart())
                    .then(result => {
                        uploadId = result.uploadId;
