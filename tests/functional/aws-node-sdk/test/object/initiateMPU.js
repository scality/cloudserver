...
describe('Initiate MPU', () => {
    withV4(sigCfg => {
        ...
        it('should return error if initiating MPU w/ > 2KB user-defined md', done => {
        ...
        describe('with tag set', () => {
            ...
            it('should return InvalidArgument creating mpu tag with ' + 'invalid characters: %', done => {
                const value = 'value1%';
                s3.createMultipartUpload(
                    {
                        Bucket: bucket,
            ...
            it('should return InvalidArgument creating mpu with ' + 'bad encoded tags', done => {
                s3.createMultipartUpload(
                    {
                        Bucket: bucket,
                        Key: key,
