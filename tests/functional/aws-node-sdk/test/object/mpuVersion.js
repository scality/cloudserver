...
describe('MPU with x-scal-s3-version-id header', () => {
    withV4(sigCfg => {
        ...
        afterEach(() => {
            ...
            return bucketUtil
                .emptyMany([bucketName, bucketNameMD])
                .then(() => {
        ...
        it('should fail if version is invalid', done => {
            ...
            async.series(
                [
                    ...
                    next => s3.putObject(params, next),
                    next =>
                        putMPUVersion(s3, bucketName, objectName, 'aJLWKz4Ko9IjBBgXKj5KQT.G9UHv0g7P', err => {
        ...
        it('should fail if key does not exist', done => {
            async.series(
                [
                    next =>
                        putMPUVersion(s3, bucketName, objectName, '', err => {
        ...
        it('should fail if trying to overwrite a delete marker', done => {
            ...
            async.series(
                [
                    ...
                    next =>
                        putMPUVersion(s3, bucketName, objectName, vId, err => {
