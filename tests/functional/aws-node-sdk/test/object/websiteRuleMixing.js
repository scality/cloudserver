...
describe(
    'User visits bucket website endpoint and requests resource ' + 'that has x-amz-website-redirect-location header ::',
    () => {
        ...
        describe('when x-amz-website-redirect-location: /redirect.html', () => {
            beforeEach(() => {
                ...
                return s3
                    .putBucketWebsite({ Bucket: bucket, WebsiteConfiguration: webConfig })
                    .promise()
                    .then(() =>
                        s3
                            .putObject({
        ...
        describe('when x-amz-website-redirect-location: https://www.google.com', () => {
            ...
            it('should redirect to https://www.google.com on HEAD request', done => {
                WebsiteConfigTester.checkHTML(
                    {
                        method: 'HEAD',
                        url: endpoint,
        ...
        describe(`with redirect all requests to ${redirectEndpoint}`, () => {
            ...
            it(
                `should redirect to ${redirectEndpoint} instead of ` +
        ...
        describe('with routing rule replaceKeyWith', () => {
            ...
            it(
                'should replace key instead of redirecting to key ' +
                    'x-amz-website-redirect-location header location on GET request',
                done => {
                    WebsiteConfigTester.checkHTML(
                        {
