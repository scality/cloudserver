...
describe('GET object taggings', () => {
    withV4(sigCfg => {
        ...
        it('should return empty array after putting no tag', async () => {
            const data = await s3.send(
                new GetObjectTaggingCommand({
                    Bucket: bucketName,
                    Key: objectName,
        ...
        it('should return NoSuchKey getting tag set to a non-existing object', async () => {
            try {
                await s3.send(
                    new GetObjectTaggingCommand({
                        Bucket: bucketName,
        ...
        it(
            'should return 403 AccessDenied getting tag set to an object' +
