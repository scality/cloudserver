...
describe('GET object taggings', () => {
    withV4(sigCfg => {
        ...
        it('should get an empty tag set for an object that has no tags',
        async () => {
            const data = await s3.send(new GetObjectTaggingCommand({
                Bucket: bucketName,
                Key: objectName,
        ...
        it('should get tag set to an object in a bucket created with same ' +
