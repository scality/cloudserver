    ...
    static checkHTML(browser, type, bucketName) {
        ...
        if (type.startsWith('404')) {
            ...
            if (type === '404-no-such-bucket') {
                ...
                throw new Error('This 404 error is not checked in checkHTML()');
            }
        // 403 error
            ...
            if (type === '403-access-denied') {
                ...
                throw new Error('This 403 error is not checked in checkHTML()');
            }
        ...
        } else if (type === 'scality') {
            browser.assert.status(200);
            browser.assert.text('title',
                'Scality is Storage for Digital Business');
        } else if (type === 'scality-about-us') {
            browser.assert.status(200);
            browser.assert.text('title', 'About - Scality ' +
            'Software-Defined Infrastructure Storage for Digital Business');
