...
describe('GCP: Object', function testSuite() {
                ...
                gcpClient.putObject(
                    ...
                    (err, putRes) => {
                        ...
                        gcpClient.getObject(
                            ...
                            (getErr, getRes) => {
                                assert.equal(getErr, null, `Expected success, got error ${getErr}`);
                    ...
                    [
                        ...
                        next => {
                            gcpClient
                                ...
                                .catch(err => {
                                    assert(err);
                                    assert.strictEqual(err.$metadata && err.$metadata.httpStatusCode, 404);
                                    assert.strictEqual(err.name, 'NoSuchKey');
                                    return next();
                                });
                        },
    ...
    describe('COPY Object', () => {
        ...
        describe('with existing object in bucket', () => {
                    ...
                    [
                        ...
                        next =>
                            gcpClient.deleteObject(
                                ...
                                err => {
                                    if (err) {
                                        process.stdout.write(`err in deleting copy object ${err}\n`);
                                    }
                                    return next(err);
                                },
                            ),
            ...
            it('should successfully copy with REPLACE directive', function testFn(done) {
                        ...
                        next =>
                            gcpClient.headObject(
                                ...
                                (err, res) => {
                                    ...
                                    assert.strictEqual(res.ETag, this.test.ETag);
                                    assert.notStrictEqual(res.Metadata.value, this.test.initValue);
                                    return next();
                                },
                            ),
                    ],
            ...
            it('should successfully copy with COPY directive', function testFn(done) {
                async.waterfall(
                    [
                        next =>
                            gcpClient.copyObject(
                        ...
                        next =>
                            gcpClient.headObject(
                                ...
                                (err, res) => {
                                    ...
                                    assert.strictEqual(res.ETag, this.test.ETag);
                                    assert.strictEqual(res.Metadata.value, this.test.initValue);
                                    return next();
                                },
                            ),
                    ],
