                    ...
                    next =>
                        makeGcpRequest(
                            ...
                            (err, res) => {
                                ...
                                assert.strictEqual(this.test.contentHash, res.headers['x-goog-hash']);
                                assert.notStrictEqual(res.headers['x-goog-meta-value'], this.test.initValue);
                                return next();
                            }
                        ),
                ],
                    ...
                    next =>
                        makeGcpRequest(
                            ...
                            (err, res) => {
                                ...
                                assert.strictEqual(this.test.contentHash, res.headers['x-goog-hash']);
                                assert.strictEqual(res.headers['x-goog-meta-value'], this.test.initValue);
                                return next();
                            }
                        ),
                ],
