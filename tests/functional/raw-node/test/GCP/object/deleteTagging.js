...
const { gcpRequestRetry, genDelTagObj, genUniqID } = require('../../../utils/gcpUtils');
...
function assertObjectMetaTag(params, callback) {
    return makeGcpRequest(
        ...
        (err, res) => {
            ...
            const tagRes = {};
            Object.keys(resObj).forEach(header => {
...
describe('GCP: DELETE Object Tagging', function testSuite() {
    ...
    beforeEach(function beforeFn(done) {
        ...
        const { headers, expectedTagObj, expectedMetaObj } = genDelTagObj(10, gcpTagPrefix);
