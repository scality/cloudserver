...
const { createWSAgent } = require('../../../lib/management/push');
...
describe('Websocket connection agent', () => {
    ...
    describe('with lowercase proxy env', testVariableSet('http_proxy', 'https_proxy', 'all_proxy', 'no_proxy'));

    describe('with uppercase proxy env', testVariableSet('HTTP_PROXY', 'HTTPS_PROXY', 'ALL_PROXY', 'NO_PROXY'));
});
