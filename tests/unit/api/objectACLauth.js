...
describe('object acl authorization for objectGet and objectHead', () => {
    ...
    test('should allow access to object owner', () => {
    ...
    test('should allow access to anyone if canned public-read ACL', () => {
    ...
    test('should allow access to anyone if canned public-read-write ACL', () => {
    ...
    test('should not allow access to public user if ' +
    ...
    test('should allow access to any authenticated user if ' +
        'authenticated-read ACL', () => {
        object.acl.Canned = 'authenticated-read';
        const results = requestTypes.map(type =>
            isObjAuthorized(bucket, object, type, accountToVet));
    ...
    test('should allow access to bucker owner if ' +
    ...
    test('should not allow access to public user if private canned ACL', () => {
        const results = requestTypes.map(type =>
            isObjAuthorized(bucket, object, type, accountToVet));
        assert.deepStrictEqual(results, [false, false]);
    });

    test('should not allow access to just any user if private canned ACL', () => {
        const results = requestTypes.map(type =>
            isObjAuthorized(bucket, object, type, accountToVet));
        assert.deepStrictEqual(results, [false, false]);
    });
...
describe('object authorization for objectPutACL and objectGetACL', () => {
    ...
    test('should allow access to bucket owner if ' +
    ...
    test('should allow objectPutACL access to account if ' +
    ...
    test('should allow objectGetACL access to account if ' +
