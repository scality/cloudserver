    ...
    it('should get a canned private ACL', done => {
        ...
        async.waterfall(
            [
                ...
                (corsHeaders, next) => bucketPutACL(authInfo, testPutACLRequest, log, next),
                (corsHeaders, next) => bucketGetACL(authInfo, testGetACLRequest, log, next),
            ...
            (err, result) => {
                ...
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[1], undefined);
                done();
            }
        );
    });
    ...
    it('should get a canned public-read-write ACL', done => {
        ...
        async.waterfall(
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    result.AccessControlPolicy.AccessControlList[0].Grant[2].Grantee[0].URI[0],
                    constants.publicId
                );
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[2].Permission[0], 'WRITE');
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[3], undefined);
                done();
            }
        );
    });
    ...
    it('should get a canned public-read ACL', done => {
        ...
        async.waterfall(
            ...
            (err, result) => {
                ...
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[1].Permission[0], 'READ');
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[2], undefined);
                done();
            }
        );
    });
    ...
    it('should get a canned log-delivery-write ACL', done => {
        ...
        async.waterfall(
            ...
            (err, result) => {
                ...
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[1].Permission[0], 'WRITE');
                assert.strictEqual(
                    result.AccessControlPolicy.AccessControlList[0].Grant[2].Grantee[0].URI[0],
                    constants.logId
                );
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[2].Permission[0], 'READ_ACP');
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[3], undefined);
                done();
            }
        );
    ...
    it('should get specifically set ACLs', done => {
        ...
        async.waterfall(
            ...
            (err, result) => {
                ...
                assert.strictEqual(
                    result.AccessControlPolicy.AccessControlList[0].Grant[1].Permission[0],
                    'FULL_CONTROL'
                );
                assert.strictEqual(
                ...
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[3].Permission[0], 'READ_ACP');
                assert.strictEqual(
                    result.AccessControlPolicy.AccessControlList[0].Grant[4].Grantee[0].URI[0],
                    constants.publicId
                );
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[4].Permission[0], 'WRITE');
                assert.strictEqual(
                    result.AccessControlPolicy.AccessControlList[0].Grant[5].Grantee[0].URI[0],
                    constants.logId
                );
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[5].Permission[0], 'READ');
                assert.strictEqual(result.AccessControlPolicy.AccessControlList[0].Grant[6], undefined);
                done();
            }
        );
    });
    ...
    grantsByURI.forEach(uri => {
        it('should get all ACLs when predefined group - ' + `${uri} is used for multiple grants`, done => {
            ...
            async.waterfall(
                ...
                (err, result) => {
                    assert.ifError(err);
                    const grants = result.AccessControlPolicy.AccessControlList[0].Grant;
