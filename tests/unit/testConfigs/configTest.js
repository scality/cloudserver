...
const serverSideEncryption = { cryptoScheme: 123, algorithm: 'algo', masterKeyId: 'masterKeyId', mandatory: false };
const bucketOne = new BucketInfo(
    'bucketone',
    userBucketOwner,
    userBucketOwner,
    creationDate,
...
const bucketTwo = new BucketInfo(
    'buckettwo',
    userBucketOwner,
    userBucketOwner,
    creationDate,
...
const bucketOnetWithEncryption = new BucketInfo(
    'bucketone',
    userBucketOwner,
    userBucketOwner,
    creationDate,
...
const bucketTwoWithEncryption = new BucketInfo(
    'buckettwo',
    userBucketOwner,
    userBucketOwner,
    creationDate,
...
describe('Testing Config.js function: ', () => {
    results.forEach(result => {
        it(
            `should return ${result.boolExpected} if source location ` +
