...
describe('setPartRanges function', () => {
    test('should set range on a one part object', () => {
    ...
    test('for a 3-part object, should include full first part, set range on ' +
    ...
    test('for a 3-part object, should include part of first part, all of ' +
    ...
    test('for a 3-part object, should include only a range of the middle part ' +
