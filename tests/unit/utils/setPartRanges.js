...
describe('setPartRanges function', () => {
    it('should set range on a one part object', () => {
        ...
        const actual = setPartRanges(dataLocations, outerRange);
    ...
    it(
        'for a 3-part object, should include full first part, set range on middle part and ' +
            'exclude last part if range request starts at 0 and ends in the middle of the second part',
        () => {
            const dataLocations = [
    ...
    it(
        ...
        () => {
            ...
            const actual = setPartRanges(dataLocations, outerRange);
            assert.deepStrictEqual(actual, [
                { key: '1', size: '2', start: '0', range: [2, 3] },
                { key: '2', size: '10', start: '4' },
    ...
    it(
        ...
        () => {
            ...
            const actual = setPartRanges(dataLocations, outerRange);
            assert.deepStrictEqual(actual, [{ key: '2', size: '3', start: '4', range: [1, 3] }]);
        },
    );
    ...
    it(
        ...
        () => {
            ...
            const actual = setPartRanges(dataLocations, outerRange);
            assert.deepStrictEqual(actual, [
                { key: '2', size: '9', start: '4', range: [1, 9] },
                { key: '3', size: '20', start: '14' },
            ]);
        },
    );
