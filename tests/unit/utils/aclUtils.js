...
describe('checkGrantHeaderValidity for acls', () => {
    const tests = [
        ...
        },
        {
            ...
            headers: {
                'x-amz-grant-write': 'emailaddress=user2@example.com',
            },
            result: true,
        },
        {
            ...
            headers: {
                'x-amz-grant-read-acp': 'emailaddress=superuser@example.com',
            },
            result: true,
        },
        {
        ...
        },
        {
            ...
            headers: {
                'x-amz-grant-full-control': 'uri=http://totallymadeup',
            },
            result: false,
        },
        {
            ...
            headers: {
                'x-amz-grant-read': 'emailaddress=invalidemail.com',
            },
            result: false,
        },
        {
        ...
        },
        {
            ...
            headers: {
                'x-amz-grant-write': 'madeupidentifier=123',
            },
            result: false,
        },
    ];
    ...
    tests.forEach(test => {
        it(test.it, () => {
            const actualResult = aclUtils.checkGrantHeaderValidity(test.headers);
