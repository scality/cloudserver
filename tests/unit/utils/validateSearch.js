...
const validateSearch = require('../../../lib/api/apiUtils/bucket/validateSearch');
...
describe('validate search where clause', () => {
    const tests = [
        ...
        },
        {
            ...
            searchParams:
                '`x-amz-meta-dog`="labrador" AND `x-amz-meta-age`="5" AND ' +
                '`content-length`="10"OR isDeleteMarker="true"AND `x-amz-meta-whatever`="ok"',
            result: undefined,
        },
        {
        ...
        },
        {
            ...
            searchParams:
                '`x-amz-meta-dog`="labrador" AND `x-amz-meta-age`="5" ' +
                'OR madeUp="something"OR `x-amz-meta-whatever`="ok"',
            result: errorInstances.InvalidArgument.customizeDescription(
    ...
    tests.forEach(test => {
        it(test.it, () => {
            const actualResult = validateSearch(test.searchParams);
