...
// NEED TO UPDATE ARGUMENTS IN MEM, FILE AND SPROXYD TO ADD backendInfo argument before requid
        client.put(writeStream, valueSize, keyContext, backendInfo,
            log.getSerializedUids(), (err, key) => {
                ...
                const dataRetrievalInfo = {
                    key,
                    //NEED TO UPDATE THIS!!! Probably move dataRetrievalInfo creation
                    //to each backend and just pass it through here.
