        ...
        if (config.localCache) {
            ...
            if (config.localCache.sentinels) {
                ...
                assert(Array.isArray(config.localCache.sentinels),
                    'bad config: localCache sentinels must be an array');
                config.localCache.sentinels.forEach(item => {
                    const { host, port } = item;
                    assert(typeof host === 'string',
                      'bad config: localCache sentinel host must be a string');
                    assert(typeof port === 'number',
                      'bad config: localCache sentinel port must be a number');
