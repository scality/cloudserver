...
class Config extends EventEmitter {
    ...
    _getConfig() {
        ...
        this.enableDirectToCold = process.env.ENABLE_DIRECT_TO_COLD !== undefined
            ? process.env.ENABLE_DIRECT_TO_COLD === 'true'
            : config.enableDirectToCold ?? false;
        assert(
            typeof this.enableDirectToCold === 'boolean',
            'bad config: enableDirectToCold must be a boolean',
        );
