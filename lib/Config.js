...
function sproxydAssert(configSproxyd, thisSproxyd) {
    ...
    _getConfig() {
        ...
        if (config.locationConstraints !== undefined) {
            ...
            Object.keys(config.locationConstraints).forEach(l => {
                ...
                // if (info.region !== undefined) {
                //     assert(typeof info.region === 'string',
                //         'bad config: region must be a string');
                // }
                // if (info.bucketName !== undefined) {
                //     assert(typeof info.bucketName === 'string',
                //         'bad config: bucketName must be a string');
                // }
                // if (info.credentialsProfile !== undefined) {
                //     assert(typeof info.credentialsProfile === 'string',
                ...
                if (info.connector !== undefined) {
                    ...
                    if (info.connector.sproxyd !== undefined) {
                        sproxydAssert(info.connector.sproxyd,
                            this.locationConstraints[l].information
                                .connector.sproxyd);
                    }
                }
            });
            this.locationConstraints = config.locationConstraints;
        }
        ...
        if (config.sproxyd !== undefined) {
            sproxydAssert(config.sproxyd, this.sproxyd);
        }
