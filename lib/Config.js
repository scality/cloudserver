...
const { s3routes, auth: arsenalAuth, s3middleware } = require('@scality/arsenal');
...
const { ValidLifecycleRules: supportedLifecycleRules, NotificationConfiguration } = require('@scality/arsenal').models;
const { utapiVersion } = require('@scality/utapi');
...
const {
    ...
    isValidType,
    isValidProtocol,
} = require('@scality/arsenal/build/lib/network/KMSInterface');
        ...
        if (config.utapi) {
            ...
            if (utapiVersion === 1) {
                ...
                if (config.utapi.batchSize) {
                    ...
                    assert(
                        config.utapi.batchSize > 0,
                        'bad config:' + 'utapi.batchSize must be a number greater than 0',
                    );
