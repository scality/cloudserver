...
class Config {
    ...
    _getConfig() {
        ...
        this.indexingHost = "127.0.0.1";
        if (config.indexingHost !== undefined) {
            this.indexingHost = config.indexingHost;
        }
        this.indexingPort = 7000;
        if (config.indexingPort !== undefined) {
            this.indexingPort = config.indexingPort;
        }
        return config;
    }
}
