...
export default {
    ...
    metadataStoreObject(
        ...
        // of the multipart upload.  Do NOT move this to before
    ...
    metadataValidateMultipart(params, cb) {
        ...
        bucket.getMultipartUploadMD(uploadId,
            function returnMultipartMD(multipartNotFound, multiPartUpload) {
                ...
                // ARN.  So, accessKey here should be canonicalID or
                // ARN (if applicable)
                const isInitiator =
     ...
     */
    deleteMultipartUploadEntry(bucket, uploadId) {
        bucket.deleteMultipartUploadMD(uploadId, () => {
            console.log('Bucket after delete of multipart metadata', bucket);
        });
    }
};
