...
export default {
     ...
     */
    createBucket(accessKey, bucketName, headers, locationConstraint, log, cb) {
     ...
     */
    deleteBucket(bucketName, accessKey, log, cb) {
    ...
    * JSON response from metastore
    */
    getMultipartUploadListing(MPUbucketName, listingParams, log,
        cb) {
        assert.strictEqual(typeof MPUbucketName, 'string');
