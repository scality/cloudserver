...
const externalBackendUtils = require('./data/external/utils');
...
const services = {
    ...
    */
    ...
    deleteObject(bucketName, objectMD, objectKey, options, log, cb) {
        ...
        if (objGetInfo && objGetInfo[0].dataStoreType === 'azure') {
            return externalBackendUtils.protectAzureBlocks(objGetInfo,
            bucketName, objectKey, log, err => {
