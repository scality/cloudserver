...
export default {
    ...
    */
     ...
     * @return {undefined}
     */
    deleteObject(bucketName, objectMD, objectKey, backendInfo, log, cb) {
            ...
            return metadata.deleteObjectMD(bucketName, objectKey, log,
                err => {
                    ...
                    if (objectMD.location === null) {
                        ...
                        return data.delete(objectMD.location,
                            backendInfo, deleteLog);
                    }
                    return data.batchDelete(objectMD.location,
                        backendInfo, deleteLog);
                });
        }
        // versioning
