...
const services = {
     ...
     * @param {object} bucket - bucket in which objectMetadata is stored
     * @param {object} responseMetaHeaders - contains user meta headers to be
     * passed to response
     * @param {object} metastore - metadata store
     ...
     */
    deleteBucket(
        bucket, responseMetaHeaders, metastore, bucketUID, accessKey, cb) {
    ...
    /**
     * Called by bucketDelete.
     * @param {object} bucket - bucket in which metadata is stored
     * @param {object} metadataCheckParams - contains
     * lowercased headers from request object
     * @param {function} cb - callback from async.waterfall in objectGet
     * @return {function} executes callback with error,
     * bucket and metadataCheckParams
     * as arguments
     */

    bucketMetadataChecks(bucket, metadataCheckParams, cb) {
