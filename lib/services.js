...
export default {
    ...
    metadataValidateAuthorization(params, cb) {
        ...
        (err, data) => {
            ...
            const bucket = data.bucket ? JSON.parse(data.bucket) : undefined;
    ...
    metadataStoreObject(bucketName, objectMetadata, key, params, cb) {
        ...
        // until cors are implemented, set to empty string so that s3cmd
        // correctly responds to an info request.
        omVal.cors = '';
        omVal.acl = {
            Canned: 'private',
            FULL_CONTROL: [],
