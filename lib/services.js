...
const services = {
    ...
    */
     ...
     * @param {string} [originOp=s4:ObjectRemoved:Delete] - origin operation
     * @return {undefined}
     */
    deleteObject(bucketName, objectMD, objectKey, options, log, cb, originOp = 's3:ObjectRemoved:Delete') {
