...
try {
    if (config.serverAccessLogs.enabled) {
        serverAccessLogger = new ServerAccessLogger(
            config.serverAccessLogs.outputFile,
            config.serverAccessLogs.highWaterMarkBytes,
            config.serverAccessLogs.retryReopenDelayMS,
            config.serverAccessLogs.checkFileRotationIntervalMS,
        );
