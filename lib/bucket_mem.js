...
Bucket.prototype.GETBucketListObjects = function(prefix, marker, delimiter, maxKeys, callback){
    ...
    var tempKey = current_key.slice(prefixLength);
    console.log("current_key", current_key)
    console.log("tempKey", tempKey);
		if(delimiter){
			var delimiter_index_after_prefix = tempKey.indexOf(delimiter);
			delimiter_index = delimiter_index_after_prefix + prefixLength;
		...
		if(delimiter_index > -1 && delimiter_index_after_prefix > -1){
