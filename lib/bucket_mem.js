...
Bucket.prototype.PUTObject = function (key, value, callback) {
    ...
    process.nextTick(function () {
        ...
        if (callback) {
                // If error could arise in operation return error as first argument in callback
            callback(null);
        }
    });
};
...
Bucket.prototype.DELETEObject = function (key, callback) {
    ...
    process.nextTick(function () {
        ...
        if (callback) {
          // If error could arise in delete operation return error as first argument in callback
            callback(null);
        }
    });
};
