        ...
        return metadata.getObjectMD(bucketName, errorDocument, {}, log,
            (errObjErr, errObjMD) => {
                ...
                if (!isObjAuthorized(bucket, errObjMD, 'objectGet',
                    constants.publicId, null, request.isImplicitIdentityDeny, log)) {
            ...
            (err, objMD) => {
                ...
                if (err) {
                    ...
                    const bucketAuthorized = isBucketAuthorized(bucket,
                      'bucketGet', constants.publicId, null, request.isImplicitIdentityDeny, log, request);
                ...
                if (!isObjAuthorized(bucket, objMD, 'objectGet',
                    constants.publicId, null, request.isImplicitIdentityDeny, log, request)) {
