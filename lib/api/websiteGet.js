...
function _errorActions(err, errorDocument, routingRules,
    bucketName, objectKey, indexDocument, log, callback) {
...
function websiteGet(request, log, callback) {
    ...
    return metadata.getBucket(bucketName, log, (err, bucket) => {
        ...
        const indexDocument = websiteConfig.getIndexDocument();
        ...
        if (keyRoutingRule) {
            ...
            return callback(null, false, null, null,
                keyRoutingRule, objectKey, indexDocument);
        }
            ...
            (err, objMD) => {
                if (err) {
                    ...
                    return _errorActions(error,
                      ...
                      bucketName, objectKey, indexDocument,
                      log, callback);
                }
