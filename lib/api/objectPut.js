...
function objectPut(authInfo, request, streamingV4Params, log, callback, authorizationResults, oTel) {
    ...
    return tracer.startActiveSpan('Validating and Storing Object in S3', undefined, cloudserverApiSpanContext, objectPutSpan => {
        ...
        (err, bucket, objMD) => {
            ...
            return async.waterfall([
                ...
                (next) => tracer.startActiveSpan('Object Creation and Storage in S3', undefined, objectPutSpanContext, currentSpan => {
                    currentSpan.setAttributes({
                        'code.function': 'objectPut()',
                        'code.filename': 'lib/api/objectPut.js',
                        'code.lineno': 229,
