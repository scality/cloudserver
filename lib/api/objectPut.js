 ...
 * store object location returned by datastore and object's (custom) headers in metadata and
 * return the result in final callback
 * 
 * @param  {[string]}   accessKey [description]
 * @param  {[datastore]}   datastore [description]
 * @param  {[metastore]}   metastore [description]
