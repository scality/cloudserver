...
const ObjectLockConfiguration = require('arsenal').models.ObjectLockConfiguration;
...
function bucketGetObjectLock(authInfo, request, log, callback) {
    ...
    return standardMetadataValidateBucket(metadataValParams, request.actionImplicitDenies, log, (err, bucket) => {
        ...
        if (!objectLockEnabled) {
            ...
            return callback(errors.ObjectLockConfigurationNotFoundError, null, corsHeaders);
        }
