...
function bucketGet(authInfo, request, log, callback) {
    ...
    metadataValidateBucket(metadataValParams, log, (err, bucket) => {
        ...
        if (params.search !== undefined || params.search === 'test') {
            ...
            // if it would help
            // I NEED TO LIST SESSIONS. //If there is an idle one, use random idle.
            // Create session otherwise.  But not more than 5 sessions total that are not dead.
            // Return error -- slow down requests.
