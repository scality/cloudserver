...
function bucketGet(authInfo, request, log, callback) {
    ...
    metadataValidateBucket(metadataValParams, log, (err, bucket) => {
        ...
        if (params.search !== undefined) {
            ...
            // TODO: parse actual search
            const codeToExecute = '2 + 2';
            // TODO: consider doing listing and finding available session
            ...
            return livyClient.getSessionOrBatchState('session', defaultSession,
                err => {
                    if (err && err.message === 'Not Found') {
                        ...
                        (err, res) => {
                            ...
                            return handleStatement(res.id, codeToExecute,
                                corsHeaders, bucketName, listParams, callback);
                        });
                    }
                    ...
                    return handleStatement(defaultSession, codeToExecute,
                        corsHeaders, bucketName, listParams, callback);
                });
        }
