...
const replicationVersioningErrorMessage =
    'A replication configuration is present on this bucket, so you cannot change the versioning ' +
    'state. To change the versioning state, first delete the replication configuration.';
