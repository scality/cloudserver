 ...
 * @param {boolean} [isExpiration=false] - true if the call comes from LifecycleExpiration
 * @return {undefined}
 */
function objectDelete(authInfo, request, log, cb, isExpiration = false) {
    ...
    return async.waterfall([
        ...
        function deleteOperation(bucketMD, objectMD, next) {
            ...
            const originOp = isExpiration ? 's3:LifecycleExpiration:Delete' : null;
            const originOpDeleteMarker = isExpiration ? 's3:LifecycleExpiration:DeleteMarkerCreated' : null;
            ...
            if (delOptions && delOptions.deleteData) {
                ...
                return services.deleteObject(bucketName, objectMD, objectKey,
                    ...
                    objectMD, delResult, deleteInfo), originOp);
            }
