...
export default function completeMultipartUpload(
    ...
    async.waterfall([
        ...
        function waterfall5(mpuBucket, storedMetadata, aggregateEtag,
            ...
            // TODO: In metadata integration refactor, need to replace this
            // with getBucket call
            const destinationBucket = metastore.buckets[bucketUID];
            return next(null, destinationBucket, dataLocations, metaStoreParams,
                mpuBucket, mpuOverviewKey, aggregateEtag, storedPartsAsObjects,
        ...
        function waterfall6(destinationBucket, dataLocations,
            ...
            storedPartsAsObjects, duplicatePartsToDelete, next) {
            services.metadataStoreObject(destinationBucket, undefined,
