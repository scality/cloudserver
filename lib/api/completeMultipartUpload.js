...
function completeMultipartUpload(authInfo, request, log, callback) {
    ...
    async.waterfall([
        ...
        function waterfall4(mpuBucket, storedParts, jsonList, next) {
            ...
            metadata.getObjectMD(mpuBucket.getName(), mpuOverviewKey, log,
                (err, storedMetadata) => {
                    if (err) {
                        return next(err);
                    }
        ...
        function waterfall6(destinationBucket, dataLocations,
            ...
            services.metadataStoreObject(destinationBucket.getName(), undefined,
        ...
        function waterfall7(mpuBucket, mpuOverviewKey, aggregateETag,
            ...
            services.batchDeleteObjectMetadata(
                mpuBucket.getName(), keysToDelete, log, (err) => {
