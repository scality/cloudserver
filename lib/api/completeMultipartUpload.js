...
function completeMultipartUpload(authInfo, request, log, callback) {
    ...
    console.log('===========================')
    console.log('Hitting API method', Date.now(), Date.now().toUTCString);
    console.log('===========================')
    ...
    async.waterfall([
        function waterfall1(next) {
            console.log('===========================')
            console.log('Waterfall1', Date.now(), new Date().toUTCString());
            console.log('===========================')
            const metadataValParams = {
                objectKey,
                authInfo,
        ...
        function waterfall2(destBucket, objMD, next) {
            console.log('===========================')
            console.log('Waterfall2', Date.now(), new Date().toUTCString());
            console.log('===========================')
        ...
        function waterfall3(destBucket, objMD, mpuBucket, next) {
            console.log('===========================')
            console.log('Waterfall3', Date.now(), new Date().toUTCString());
            console.log('===========================')
            if (request.post) {
        ...
        function waterfall4(destBucket, objMD, mpuBucket, jsonList, next) {
            console.log('===========================')
            console.log('Waterfall4', Date.now(), new Date().toUTCString());
            console.log('===========================')
        ...
        next) {
            console.log('===========================')
            console.log('Waterfall5', Date.now(), new Date().toUTCString());
            console.log('===========================')
            ...
            console.log('======================================================')
            console.log('about to enter outer loop', Date.now(), new Date().toUTCString())
            console.log('======================================================')
            for (let i = 0; i < partLength; i++) {
                ...
                // in numerical order
                // return an error
                console.log('checking if parts are in numerical order')
                ...
                console.log('checking if part needs to be converted to hex from base64')
                ...
                if (partETag.length !== 32) {
                    console.log('part is base64 encoded')
                ...
                console.log('checking part ETag does not match uploaded part ETag')
                ...
                console.log('allowing smaller part')
                ...
                for (let j = 0; j < storedPartsAsObjects[i].locations.length;
                    ...
                    if (!location || typeof location !== 'object') {
                        console.log('no location, moving on')
                        console.log('===============')
                        continue;
                    }
                    ...
                    console.log('pieceRetrievalInfo', pieceRetrievalInfo)
                ...
                console.log('partETag', partETag);
                console.log('===========================')
            }
            console.log('======================================================')
            console.log('got outside loop', Date.now(), new Date().toUTCString())
            console.log('======================================================')
            ...
            return metadata.getObjectMD(mpuBucket.getName(), mpuOverviewKey,
                log, (err, storedMetadata) => {
                    ...
                    console.log('===========================')
                    console.log('Successfully fetched objectMD.', Date.now(), new Date().toUTCString());
        ...
        function waterfall6(destBucket, objMD, mpuBucket, storedMetadata,
            ...
            console.log('===========================')
            console.log('Entered waterfall 6.', Date.now(), new Date().toUTCString());
        ...
        function waterfall7(destinationBucket, dataLocations,
            ...
            console.log('===========================')
            console.log('Entered waterfall7.', Date.now(), new Date().toUTCString());
            ...
            services.metadataStoreObject(destinationBucket.getName(),
                dataLocations, pseudoCipherBundle, metaStoreParams, err => {
                    ...
                    console.log('===========================')
                    console.log('Successfully stored metadata', Date.now(), new Date().toUTCString());
                    ...
                    console.log('===========================')
                    console.log('Sent batchdelete request if detected need.', Date.now(), new Date().toUTCString());
        ...
        function waterfall8(mpuBucket, mpuOverviewKey, aggregateETag,
            ...
            console.log('===========================')
            console.log('Entered waterfall8', Date.now(), new Date().toUTCString());
        ...
        console.log('===========================')
        console.log('Entered waterfall callback with these parameters:', Date.now(), new Date().toUTCString());
        console.log('err', err);
