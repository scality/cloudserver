        ...
        [
            ...
            function processParts(
                    ...
                    fc => {
                        try {
                            ...
                            if (checksumErr) {
                                ...
                                return callNext(arsenalErrorFromChecksumError(checksumErr), destBucket);
                            }
                            return continueProcessParts(null);
                        } catch (resolveErr) {
                            ...
                            return callNext(resolveErr, destBucket);
                        }
                    },
                    computeErr => {
                        ...
                        return callNext(computeErr, destBucket);
                    },
                );
                return undefined;
                ...
                function continueProcessParts() {
                    ...
                    if (partsInfo.error) {
                        return callNext(partsInfo.error, destBucket);
                    }
