...
const api = {
    ...
    callApiMethodWithParallelAuth(apiMethod, request, response, log, callback) {
        // Implementation will go here in a future PR
        // For now, just fall back to the standard method
        return this.callApiMethod(apiMethod, request, response, log, callback);
    },
