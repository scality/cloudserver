...
function objectCopy(authInfo, request, sourceBucket,
    ...
    const valGetParams = {
        ...
        log,
        // TODO uncomment when versioning objectCopy is available
        // query: request.query,
    };
    const valPutParams = {
        authInfo,
    ...
    return async.waterfall([
        ...
        function goGetData(storeMetadataParams, dataLocator, destBucketMD,
            ...
            _storeMetadataParams.versioningConfiguration =
                destBucketMD.getVersioningConfiguration();
