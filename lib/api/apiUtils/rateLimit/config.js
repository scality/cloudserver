...
const {
    rateLimitDefaultConfigCacheTTL,
    rateLimitDefaultCacheMaxItems,
...
const rateLimitConfigSchema = Joi.object({
    ...
    configCacheMaxItems: Joi.number().integer().positive().default(rateLimitDefaultCacheMaxItems),
    bucketOwnerCacheMaxItems: Joi.number().integer().positive().default(rateLimitDefaultCacheMaxItems),
}).default({
    enabled: false,
    nodes: 1,
    tokenBucketBufferSize: 50,
    ...
    configCacheMaxItems: rateLimitDefaultCacheMaxItems,
    bucketOwnerCacheMaxItems: rateLimitDefaultCacheMaxItems,
});
...
function parseRateLimitConfig(rateLimitingConfig) {
    ...
    const parsed = {
        ...
        configCacheMaxItems: validated.configCacheMaxItems,
        bucketOwnerCacheMaxItems: validated.bucketOwnerCacheMaxItems,
