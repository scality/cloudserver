 ...
 * @param {string} [isExpiration=false] - is from expiration workflow
...
function createAndStoreObject(bucketName, bucketMD, objectKey, objMD, authInfo,
        ...
        log, callback, isExpiration = false) {
    ...
    if (isDeleteMarker && objMD) {
        ...
        metadataStoreParams.originOp = isExpiration ?
            's3:LifecycleExpiration:DeleteMarkerCreated' : 's3:ObjectRemoved:DeleteMarkerCreated';
    }
