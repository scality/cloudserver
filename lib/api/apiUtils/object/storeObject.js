 ...
 * accessKey, signatureFromRequest, region, scopeDate, timestamp, and
 * credentialScope (to be used for streaming v4 auth if applicable)
 * @param {object} backendInfo - info to determine which data backend to use
 * @param {string} [backendInfo.objectLocationConstraint] - location constraint
 * for object
 * @param {string} [backendInfo.bucketLocationConstraint] - location constraint
 * for bucket
 * @param {string} [backendInfo.requestEndpoint] - endpoint to which put
 * request was made
