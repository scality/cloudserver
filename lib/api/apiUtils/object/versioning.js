...
function versioningPreprocessing(bucketName, bucketMD, objectKey, objMD,
    ...
    if (nullVersionId) {
        operations.push(function storeNullVersionMD(next) {
            return _storeNullVersionMD(bucketName, objectKey, nullVersionId, objMD, log, next);
        });
    }
    
    if (delOptions) {
        operations.push(function prepareNullVersionDeletion(next) {
        ...
        if (delOptions.versionId && delOptions.versionId !== 'null') {
            operations.push(function deleteNullVersionMD(next) {
