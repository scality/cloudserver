...
splitter, log) {
    ...
    storedParts.forEach(item => {
        ...
        storedPartsCopy.push({
            ...
            extraMD: item.value.partLocations[0].extraMetadata,
            // extraMD was created because b2 additionnal backend need to send
            // completeMPU request with checksums sha1 instead md5.
