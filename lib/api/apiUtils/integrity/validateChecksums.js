...
const { errors: ArsenalErrors, errorInstances } = require('@scality/arsenal');
 ...
 * @param {boolean} [checksumUnavailable] - no final checksum could be composed
 *   because one or more parts carry no stored digest.
 * @returns {{error: string, details: object}|null}
 */
function validateCompleteMultipartUploadChecksum(headers, finalChecksum, checksumUnavailable) {
