...
function bucketGetWebsite(authInfo, request, log, callback) {
    ...
    metadata.getBucket(bucketName, log, (err, bucket) => {
        ...
        if (bucketShield(bucket, requestType)) {
            monitoring.promMetrics('GET', bucketName, 404, 'getBucketWebsite');
        ...
        if (
            ...
            monitoring.promMetrics('GET', bucketName, 403, 'getBucketWebsite');
        ...
        monitoring.promMetrics('GET', bucketName, '200', 'getBucketWebsite');
