    ...
    return waterfall(
        [
            ...
            (tags, next) => {
                ...
                metadata.updateBucket(bucket.getName(), bucket, log, err => next(err));
            },
        ],
        err => {
            ...
            if (err) {
                ...
                monitoring.promMetrics('PUT', bucketName, err.code, 'putBucketTagging');
            } else {
                monitoring.promMetrics('PUT', bucketName, '200', 'putBucketTagging');
