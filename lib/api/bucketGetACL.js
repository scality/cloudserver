 ...
 */
export default function bucketGetACL(accessKey, metastore, request, log,
    callback) {
    log.debug('Processing the request in Bucket GET ACL api');
    ...
    async.waterfall([
        ...
        if (err) {
            log.error(`Error in Bucket GET ACL: ${err}`);
