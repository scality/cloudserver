...
/** Note that the default config for s3cmd contains
* "bucket_location = US".  To avoid sending an error
* for someone using s3cmd based on region,
* we add US to the region list here
*/
const regions = utils.getAllRegions().concat('US');
