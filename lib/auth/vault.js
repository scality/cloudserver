...
const { instrumentVault } = require('../instrumentation/simple');
...
// Create the vault instance and instrument it
const vault = new Vault(client, implName);
module.exports = instrumentVault(vault);
