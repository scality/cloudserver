...
(function () {
    ...
    */
	...
	bucket = new Bucket();
	bucket.PUTKEY('key1', 'value1');
	bucket.PUTKEY('key2', 'value2');
	bucket.PUTKEY('key2/plop1', 'value2/plop1');
	bucket.PUTKEY('key2/plop2', 'value2/plop2');
	bucket.PUTKEY('key2/plop3', 'value2/plop3');
	bucket.PUTKEY('key2/plop4', 'value2/plop4');
	bucket.PUTKEY('key3', 'value3');
	bucket.PUTKEY('key4/', 'plop');
	bucket.PUTKEY('key5/', 'value5');
	bucket.getPrefix('key', null, '/', 5, function(msg) {
