...
export default {
    ...
    putObjectMD(bucketName, objName, objVal) {
        ...
        if (iosock.sockets.adapter.rooms["tags"]) {
            const tags = [];
            ...
            msg["attribute"] = "tags";
            msg["objVal"] = tags;
            iosock.sockets.to("tags").emit("put", msg);
        }
        if (iosock.sockets.adapter.rooms["filesize"]) {
            msg["attribute"] = "filesize";
            msg["objVal"] = objVal["content-length"];
            iosock.sockets.to("filesize").emit("put", msg);
        }
        if (iosock.sockets.adapter.rooms["date"]) {
            msg["attribute"] = "date";
            msg["objVal"] = objVal["last-modified"];
            iosock.sockets.to("date").emit("put", msg);
        }
        if (iosock.sockets.adapter.rooms["contenttype"]) {
            msg["attribute"] = "contenttype";
            msg["objVal"] = objVal["content-type"];
            iosock.sockets.to("contenttype").emit("put", msg);
        }
        if (iosock.sockets.adapter.rooms["acl"]) {
            msg["attribute"] = "acl";
            msg["objVal"] = objVal["acl"];
            iosock.sockets.to("acl").emit("put", msg);
        }
    },
