    ...
    return new Promise((resolve, reject) => {
        ...
        dataStream.on('end', () => {
            if (exceeded) {
                ...
                return settle(errors.InternalError);
            }
            return settle(null, value.toString());
        });
    });
}
...
module.exports = {
    _decodeURI,
    // callbackify keeps backward compatibility with put.js which still uses the callback form
    receiveData,
    respondWithData,
    getResponseHeader,
    buildHeadXML,
