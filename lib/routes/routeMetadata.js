...
const params = {};
params.bucketdBootstrap = config.bucketd.bootstrap;
params.bucketdLog = config.bucketd.log;
params.https = config.https;

const metadata = new BucketClientInterface(params, bucketclient, logger);
