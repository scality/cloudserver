...
const routesUtils = {
     ...
     * @param {string} indexDocument - index document's name
     * @param {boolean} encrypted - whether request was https
     * @param {object} response - response object
     * @param {string} hostHeader - host's header from headers.host
     * @param {object} log - Werelogs instance
     * @return {undefined}
     */
    redirectRequest(routingInfo, objectKey, indexDocument, encrypted, response,
      hostHeader, log) {
        ...
        if (objectKey === undefined) {
            ...
            redirectKey = objectKey.replace(indexDocument, '');
        } else {
            redirectKey = objectKey;
        }
        ...
        if (replaceKeyPrefixWith !== undefined) {
            if (prefixFromRule !== undefined) {
                ...
                redirectKey = objectKey === indexDocument ? replaceKeyPrefixWith
                : replaceKeyPrefixWith + objectKey;
            }
        }
