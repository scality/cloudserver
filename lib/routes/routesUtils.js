 ...
 * @return {object} response - response object with additional headers
 */
function okHeaderResponse(headers, response) {
...
const routesUtils = {
     ...
     * @return {function} - error or success response utility
     */
    responseNoBody(errCode, resHeaders, response) {
        if (errCode) {
            return errorXMLResponse(errCode, response);
        }
        return okHeaderResponse(resHeaders, response);
    },
    ...
    responseContentHeaders(errCode, overrideHeaders, resHeaders, response) {
        ...
        return okContentHeadersResponse(overrideHeaders, resHeaders, response);
    },
