...
function putObject(request, response, log, callback) {
    console.log("GGGGGGG 43", request.headers)
    console.log("GGGGGGG 43", request.query)
    console.log("GGGGGGG 43", request.query.Signature)
...
function routeBackbeat(clientIP, request, response, log) {
    ...
    console.log("GGGGGGG 56", request.headers)

    return async.waterfall([
        next => auth.server.doAuth(
            request, log, (err, userInfo, authorizationResults, streamingV4Params, infos) => {
                console.log("GGGGGGG 57", err)
                console.log("GGGGGGG 58", userInfo)
                console.log("GGGGGGG 59", authorizationResults)
