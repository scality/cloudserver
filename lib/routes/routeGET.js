...
import listMultipartUploads from '../api/listMultipartUploads';

export default function routerGET(request, response, metastore) {
    ...
    Auth.checkAuth(request, function checkAuthRes(err, accessKey) {
        ...
        if (bucketname === undefined && objectKey === undefined) {
            ...
            if (request.query.acl !== undefined) {
                ...
                // Get object
                objectGet(accessKey, metastore, request,
