...
function _createEncryptedBucket(host, port, bucketName, accessKey, secretKey, verbose, ssl, locationConstraint) {
    const options = {
        host,
        port,
        method: 'PUT',
...
function createEncryptedBucket() {
    ...
    _createEncryptedBucket(host, port, bucket, accessKey, secretKey, verbose, ssl, locationConstraint);
}
