...
const KMIPClient = require('@scality/arsenal').network.kmipClient;
const KMIPClusterClient = require('@scality/arsenal').network.kmipClusterClient;
const { KmsAWSClient } = require('@scality/arsenal').network;
