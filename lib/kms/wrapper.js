...
function getScalityKms() {
    ...
    try {
        ...
        // TODO add scality arn in scality-kms
        ...
        */
        ...
        if (algorithm === 'AES256' || algorithm === 'aws:kms') {
            ...
            if (algorithm === 'aws:kms' && configuredMasterKeyId) {
                ...
                serverSideEncryptionInfo.configuredMasterKeyId = configuredMasterKeyId.startsWith('arn:scality:kms:')
                    ? configuredMasterKeyId
                    : `${client.arnPrefix}${configuredMasterKeyId}`;
