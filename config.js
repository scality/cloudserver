...
// For each namespace, metadata should have a shadow bucket created
// in which to hold a list of all of the user buckets.
// The name of this bucket is specified here.
config.usersBucket = 'users...bucket';
